...
(def muon-symbols ["<-" "..." "test" "clj-step" "return" "continue"])
...
(defn load-with-dependencies [module-name muon-path]
    ...
    (if (empty? modules-to-load)
      ...
      (if (modules-loaded (first modules-to-load))
        ...
        (let [module-name (first modules-to-load)
              ...
              [module-statements module-deps] (load-single-module module-name muon-path)]
